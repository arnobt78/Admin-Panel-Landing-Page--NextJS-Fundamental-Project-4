...
const navItems: { title: string; to: string; icon: React.ReactNode }[] = [
  ...
  { title: "Manage Team", to: "/team", icon: <Users className="h-5 w-5 shrink-0" /> },
  { title: "Contacts Information", to: "/contacts", icon: <Contact className="h-5 w-5 shrink-0" /> },
  { title: "Invoices Balances", to: "/invoices", icon: <Receipt className="h-5 w-5 shrink-0" /> },
  { title: "Profile Form", to: "/form", icon: <User className="h-5 w-5 shrink-0" /> },
  { title: "Calendar", to: "/calendar", icon: <Calendar className="h-5 w-5 shrink-0" /> },
  { title: "FAQ Page", to: "/faq", icon: <HelpCircle className="h-5 w-5 shrink-0" /> },
  { title: "Bar Chart", to: "/bar", icon: <BarChart3 className="h-5 w-5 shrink-0" /> },
  { title: "Pie Chart", to: "/pie", icon: <PieChart className="h-5 w-5 shrink-0" /> },
  { title: "Line Chart", to: "/line", icon: <TrendingUp className="h-5 w-5 shrink-0" /> },
  { title: "Geography Chart", to: "/geography", icon: <Map className="h-5 w-5 shrink-0" /> },
];
